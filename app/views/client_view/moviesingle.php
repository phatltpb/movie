		...
		<div class="row ipad-width2">
			<div class="col-md-4 col-sm-12 col-xs-12">
				<div class="movie-img sticky-sb">
					<img src="<?=$row['image_lage']?>" alt="">
					<div class="movie-btn">	
						<div class="btn-transform transform-vertical red">
							<div><a href="#" class="item item-1 redbtn"> <i class="ion-play"></i> Watch Trailer</a></div>
							<div><a href="<?=$row['traller']?>" class="item item-2 redbtn fancybox-media hvr-grow"><i class="ion-play"></i></a></div>
						</div>
				...
				<div class="movie-single-ct main-content">
					...
					<div class="movie-rate">
						<div class="rate">
							...
							<p><span><?=$row['status']?></span> /<?=$row['rate']?><br>
								<span class="rv">56 Reviews</span>
							</p>
						</div>
						<div class="rate-star">
							<p>Rate This Movie:  </p>
						<?php  for ($i=0; $i <round($row['status']); $i++) { 
							echo 	'<i class="ion-ios-star"></i>';
								} ?>
							<?php for ($i=0; $i <(round($row['rate'])-round($row['status'])) ; $i++) { 
						            ...
						            <div class="row">
						            	<div class="col-md-8 col-sm-12 col-xs-12">
											...
											<div class="mv-user-review-item">
												...
												<p>Đây là một trong những bộ phim yêu thích của tôi từ MCU. Việc giới thiệu các Nhân vật mới cả tốt lẫn xấu cũng khiến bộ phim trở nên hấp dẫn hơn. để các nhân vật có nhiều câu chuyện hơn cũng có thể giúp khán giả liên hệ nhiều hơn với các nhân vật khác nhau tốt hơn và nó kết nối sự gắn bó giữa khán giả và diễn viên hoặc nhân vật. Đã xem bộ phim ba lần không khiến tôi bận tâm ở đây vì nó luôn hồi hộp và thú vị mỗi khi tôi xem nó. Nói cách khác, bộ phim hay hơn nhiều so với các bộ phim trước (và tôi thực sự yêu thích mọi thứ của Marvel), cốt truyện tuyệt vời (họ thực sự thể hiện mình trong mỗi bộ phim, không có vấn đề gì khi xem nó nhiều hơn một lần.</p>
											</div>
						            	</div>
...
<script src="http://localhost/php%202/asm/public/assets/client/js/jquery.js"></script>
	<script src="http://localhost/php%202/asm/public/assets/client/js/plugins.js"></script>
	<script src="http://localhost/php%202/asm/public/assets/client/js/plugins2.js"></script>
	<script src="http://localhost/php%202/asm/public/assets/client/js/custom.js"></script>
</body>
