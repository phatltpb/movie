                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body"> 
                                            <form method="POST" action="<?=_WEB_ROOT?>/premiere_create">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <!-- text input -->
                                                        <div class="form-group">
                                                            <label>tên phim</label>
                                                            <select class="form-control" name="name_mv">
                                                               <?php
                                                                foreach($show_mv as $r){?>
                                                                     <option><?=$r['name_mv']?></option>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" placeholder="Enter ..."name="day">
                                                        </div>
                                                    </div>
                                                </div>
